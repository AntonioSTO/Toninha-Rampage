...
toninha_maga = Personagem_batalha("Toninha Maga", 500, 1, 1, (0, 0),0, sprite_maga_d, sprite_maga_e, sprite_maga_ataque, sprite_maga_ataque, sprite_maga_dano, sprite_maga_agua, dist, area)
toninha_golem = Personagem_batalha("Toninha Golen", 1200, 2, 0.5, (0, 0),0, sprite_golem_d, sprite_golem_e, sprite_golem_ataque,sprite_golem_ataque, sprite_golem_dano, sprite_golem_agua, fisico, stun)
toninha_rei = Personagem_batalha("Toninha Rei", 800, 1, 1.5, (0, 0),0, sprite_rei_d, sprite_rei_e, sprite_rei_ataque,sprite_rei_ataque, sprite_rei_dano, sprite_rei_agua, fisico, evoque)        #gerador de minions
toninha_monge = Personagem_batalha("Toninha Monge", 600, 1, 2, (0, 0),0, sprite_monge_d, sprite_monge_e, sprite_monge_ataque, sprite_monge_cura, sprite_monge_dano, sprite_monge_agua, fisico, cura)

soldado_atirador = Personagem_batalha("Soldado Atirador", 500, 1, 1, (0, 0),1, sprite_atirador_d, sprite_atirador_e, sprite_atirador_ataque, sprite_atirador_ataque, sprite_atirador_dano, sprite_atirador_agua, dist, area)
soldado_parrudo = Personagem_batalha("Soldado Parrudo", 1100, 2, 0.5, (0, 0),1, sprite_parrudo_d, sprite_parrudo_e, sprite_parrudo_ataque, sprite_parrudo_ataque, sprite_parrudo_dano, sprite_parrudo_agua, fisico, stun)
soldado_general = Personagem_batalha("General", 800, 1, 1.5, (0, 0),1, sprite_general_d, sprite_general_e, sprite_general_ataque, sprite_general_ataque, sprite_general_dano, sprite_general_agua, fisico,evoque)        #gerador de minions
soldado_medico = Personagem_batalha("Soldado Medico", 600, 1, 2, (0, 0),1, sprite_medico_d, sprite_medico_e,sprite_medico_ataque, sprite_medico_cura, sprite_medico_dano, sprite_medico_agua, fisico, cura)

amogus1 = Personagem_batalha("AMOGUS", 700, 1, 1.5, (0, 0),0, sprite_amogus1, sprite_amogus2, sprite_amogus_ataque, sprite_amogus_ataque, sprite_amogus_dano, sprite_amogus_agua, fisico, tp)
amogus2 = Personagem_batalha("AMOGUS", 700, 1, 1.5, (0, 0),0, sprite_amogus1, sprite_amogus2, sprite_amogus_ataque, sprite_amogus_ataque, sprite_amogus_dano, sprite_amogus_agua, fisico, tp)
