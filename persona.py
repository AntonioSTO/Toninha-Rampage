...
toninha_maga = Personagem_batalha("Toninha Maga", 500, 1, 1, (0, 0),0, sprite_maga_d, sprite_maga_e, sprite_maga_ataque, sprite_maga_ataque, sprite_maga_dano, sprite_maga_agua, sprite_maga_death, dist, area)
...
toninha_rei = Personagem_batalha("Toninha Rei", 800, 1, 1.5, (0, 0),0, sprite_rei_d, sprite_rei_e, sprite_rei_ataque,sprite_rei_ataque, sprite_rei_dano, sprite_rei_agua, sprite_rei_death, fisico, evoque)        #gerador de minions
...
soldado_atirador = Personagem_batalha("Soldado Atirador", 500, 1, 1, (0, 0),1, sprite_atirador_d, sprite_atirador_e, sprite_atirador_ataque, sprite_atirador_ataque, sprite_atirador_dano, sprite_atirador_agua, sprite_atirador_death, dist, area)
...
soldado_general = Personagem_batalha("General", 800, 1, 1.5, (0, 0),1, sprite_general_d, sprite_general_e, sprite_general_ataque, sprite_general_ataque, sprite_general_dano, sprite_general_agua, sprite_general_death, fisico,evoque)        #gerador de minions
soldado_medico = Personagem_batalha("Soldado Medico", 600, 1, 2, (0, 0),1, sprite_medico_d, sprite_medico_e,sprite_medico_ataque, sprite_medico_cura, sprite_medico_dano, sprite_medico_agua, sprite_amogus_death, fisico, cura)
